...
**2. Java moderno não é o Java de 2010.** Lambdas, streams, records, var, switch expressions — a linguagem evoluiu bastante. Estou no Java 21 e a experiência é bem mais agradável do que eu esperava.
...
Se você está em dúvida entre aprender Java ou Python para backend: olha as vagas da sua cidade e decide com base em dados, não em preferência.
